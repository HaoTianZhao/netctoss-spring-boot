...
public class MailUtil {
    ...
    static {
        ...
        password = props.getProperty("email.pass");
     ...
     * @throws UnsupportedEncodingException
     */
    public static void send(String to, String cc, String bcc, String subject, String content, String file, String charset)
            throws AddressException, MessagingException, UnsupportedEncodingException {
        send(new String[]{to}, new String[]{cc}, new String[]{bcc}, subject, content, new String[]{file}, charset);
    }
